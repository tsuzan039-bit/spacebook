...
function logout(){
  ...
  return (
    <Navbar fluid rounded className="space-navbar">
      ...
      {/* ✅ نجوم صغيرة في الخلفية زي باقي الموقع */}
 ...
 <NavbarBrand as={Link} to="/" className="space-logo">
  ...
  <div className="flex flex-col">
    ...
    <span className="space-brand-title">
      Spacebook
    </span>

    <span className="space-brand-subtitle">
...
>
  ...
  <DropdownItem
    as={Link}
    to="/bookmarks"
    className="text-white hover:!bg-fuchsia-500/10"
  >
    ⭐ Bookmarks
  </DropdownItem>
  ...
  <DropdownItem
    as={Link}
    to="/settings"
    className="text-white hover:!bg-violet-500/10"
  >
    ⚙️ Settings
  </DropdownItem>
  ...
  >
    ...
    <NavbarToggle className="space-toggle"/> 
  </div>
</> }

<NavbarCollapse className="force-nav-links">
{token ?
